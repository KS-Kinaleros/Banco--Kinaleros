          ...
          <section id='sidebar'>
            <ul className='side-menu top'>
              ...
              <a className='d-flex text-decoration-none mt-1 aling-items-center text-white'>
                <img src="../img/Bank.png" alt="logo" style={{width: '220px'}} />
                {/* <span className='fs-4 d-none d-sm-inline'>Bank</span> */}
              </a>
              ...
              {/* boton */}
              <button onClick={logOut} type="button" className="btn btn-danger btn-lg btn-cerrar position-absolute bottom-0 start-50 translate-middle-x mb-3">Cerrar sesión</button>
            </ul>
          </section>
